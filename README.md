...
#### Currently have spent around 21.5 hours on these items within the Ongoing list over the last two week

# Activity Log for weeks 14
ONGOING
|    Task Name     |    Date     |    Time   |                  Outcomes                    | Resources for Learning | To Do / Homework |
| ------------- |:--------:| -------------------- | ----------------------------------------  | ---------- | ----- |
| Group Project / Final Touches! | 19/05/2021 | 4hr | As a group we finsihed the website, added all the content we learned individually. Validated the HTML and CSS. We made sure the website was responsive! Had some trouble with the Navbar, it kept going behind the header then disappering, we wanted the nav to be sticky. It took all of use to figure it out and we relized we needed to add a z-index and position as fixed a very simple solution that took more than an hour becasue we were researching sticky!| https://www.w3schools.com/howto/tryit.asp?filename=tryhow_css_fixed_menu AND https://www.w3schools.com/howto/howto_js_navbar_sticky.asp| Put everything I've learned and the skills I've gained into future ventures! I feel like the best still i have learned from this process was debugging and stepping away for a bit then finding the simple solution! |
| Group Project / Experience builder | 12/04/2021 | 10min | I added buttons so people could go download the data I corrected and use it for themselves! I also added links to all the REST URLS we used, downside its not public and only Esri users can retrieve that data unfortunately| https://doc.arcgis.com/en/experience-builder/configure-widgets/embed-widget.htm | Add to Experience Builder |
|  JavaScript / Collab | 16/04/2021 | 1.5hr | Learned more about JavaScript to make the NavBar, I decided to keep the webDev website simple because of the group however I just javascript and bootstrap for the collab website! https://michellemarano1.github.io/TheZipFilers/ | https://www.w3schools.com/js/js_jquery_css.asp|  Used another template with this collab website, will never do it again, I spent more time figuring out their code then i would have just coding! Will spend more time learning JS and BootStrap so I never have to do that again.  |
| CSS Animations / Individual| 14/04/2021 | 4hr | I found a wave I really wanted to learn how to animate, I spent some time on W3Schools again on the CSS animations portion of the site, I could not get it the way I wanted it to look. I used code off a template that uses a CSS library that does not validate. I kept getting a Parse Error and a Value Error and upon further research on how to fix this, people have said its becasue of the library but I couldnt figure it out so i left it becasue it still works and looks cool!. I learned that animations are pretty finicky, the template i'm working with uses CSS animations plus Javascript. I like the way it look however if I had more time I would have tired to make it work with just CSS | https://www.w3schools.com/css/css3_animations.asp| Learn more Javescript! |
| BootStrap / Individual | 07/04/2021 | 1.5hr | Researched and learned about using bootstrap and when it could do to help the interactivity of our website, Went through W3 Schools and did some of their tutorial! learn buttons and triggers and Navbars. I decided to keep it simple I stayed using CSS & HTML | https://www.w3schools.com/bootstrap/ | Learn more things to how to make a website fun and interactive! |

# Activity Log for weeks 13 ONGOING
|    Task Name     |    Date     |    Time   |                  Outcomes                    | Resources for Learning | To Do / Homework |
| ------------- |:--------:| -------------------- | ----------------------------------------  | ---------- | ----- |
| Group Project / ArcGIS Online | 13/05/2021 | 3hr | Finished up the layouts in experience builder as a group, I learned how to create buttons adds images and crop images by scrolling in etc. learned the downfall to scrollable pages because you lose full control, there is now grids that you MUST follow and makes design more difficult and less fun | hhttps://www.youtube.com/watch?v=Xo6T_Qnt9Q4&ab_channel=AhinoamPollack| The next thing to be done is to figure out the different screens sizes and make the necessary changes, Need to figure out what to do with the dashboards with the smallest screen size|
| Group Project / ArcGIS Online | 12/04/2021 | 2hr | Calvin made HTML outline for webite, went in and added the CSS to it! Jessica and I figured out how to add an iframe to hold our Experience builder app! Had a big issues making it full screen had to put it in a p tag within HTML then a style="width & text-align center etc then add CSS, the only way I could make it a big enough size nothing would get cut off. Need to look into if this is just me or an issue adding these iframes. | https://doc.arcgis.com/en/experience-builder/configure-widgets/embed-widget.htm | Add to Experience Builder |
| Group Project / ArcGIS Online | 12/04/2021 | 1hr | Learned how to created MyScene on ArcGIS Online, then created an configurable app using "Compare" to compare Side by Side two scene maps MAKE SURE you check Synchronize popups under Options! This will make identify window popup on data thats the same within the two maps, without this turned on these comparing maps would be useless | https://doc.arcgis.com/en/experience-builder/build-apps/add-a-page.htm  AND https://doc.arcgis.com/en/experience-builder/build-apps/design-for-mobile-devices.htm | Downfall to creating a group App with Arc is that the Config apps arent sharable and we have to call and screenshare everytime we work on our project becasue we all have different apps on different accounts. Add into Experience Builder |
| Group Project / ArcGIS Experience Builder | 10/04/2021 | 3hr | After creating all the pages, relized we didnt use srcollable pages had to read about the different pages again and redo the site that was scrollable. Had problems with screen size with scrollable pages, to fix it I pressed custom Content width saved and published then pressed Auto and saved and published again, issue was resolved and I dont know why. | https://doc.arcgis.com/en/experience-builder/build-apps/add-a-page.htm  AND https://doc.arcgis.com/en/experience-builder/build-apps/design-for-mobile-devices.htm | Continue creating in Experience Builder |
| Mapbox/ Individual | 07/04/2021 | 1.5hr | Started up instance again to try and figure out mapbox adding my canadamap layer to my Mapbox API, still did not work and I gave up :( Servers are not for me I guess | https://docs.mapbox.com/help/tutorials/mapbox-arcgis-qgis/ AND https://community.esri.com/t5/arcgis-enterprise-questions/consume-arcgis-services-in-mapbox-gl-api/m-p/449641 | Create website to hold our project |
